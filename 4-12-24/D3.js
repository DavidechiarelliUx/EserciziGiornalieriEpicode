...
*/
let femaleCharacters = []; // Array vuoto per salvare i personaggi femminili
...
*/
for(let eye of starWarsCharacters){

switch (eye.eye_color) {
  case "blue" :
    eyeColor.blue.push(eye);
    break;
  case "yellow" :
    eyeColor.yellow.push(eye);
    break;
  case "brown" :
    eyeColor.brown.push(eye);
    break;
  case "red" :
    eyeColor.red.push(eye);
    break;
  case 'blue-gray' :
    eyeColor["blue-gray"].push(eye);
    break;
  default :
  console.log("non accetto questo colore");
}
}
console.log(eyeColor);
/* ESERCIZIO 6
...
let robot= [];
for (robot of starWarsCharacters){
  if(robot.gender === 'n/a'){
    robot.gender = "robot";
  };
  console.log(robot);
